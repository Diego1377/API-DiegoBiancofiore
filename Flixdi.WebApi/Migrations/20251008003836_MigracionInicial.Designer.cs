...
namespace Flixdi.WebApi.Migrations
{
    ...
    [Migration("20251008003836_MigracionInicial")]
            ...
            modelBuilder.Entity("Flixdi.Entities.Pelicula", b =>
                {
                    ...
                    b.Property<int>("EstudioCinematograficoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EstudioCinematograficoId");
            ...
            modelBuilder.Entity("Flixdi.Entities.Pelicula", b =>
                {
                    b.HasOne("Flixdi.Entities.EstudioCinematografico", "EstudioCinematografico")
                        .WithMany("Peliculas")
                        .HasForeignKey("EstudioCinematograficoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
